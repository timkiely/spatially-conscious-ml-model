...
```{r fig.height=8, message=FALSE, warning=FALSE, paged.print=FALSE}
...
by_boro_base <- data_frame(Borough = prob_base_data$, Actual = prob_base_data$actual, Prob = prob_base_data$probs, Pred = prob_base_data$pred)
