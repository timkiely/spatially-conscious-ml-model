...
additional data sets through feature engineering: a ``zipcode-features''
data set and a ``spatial-lag-features'' data set. The primary goal of
this study is to compare the predictive power of the spatial lag data
set vs.~the base and zipcode level features.
...
Tax Lot Ouput data set, known as
...
between 2002-2017, excluding 2008. For convinience, we also exclude the
...
BBLs. Mapping the sales data directlty to the PLUTO data results in a
...
less than 2 buildings per tax lot. The global filtering of the dataset
...
Executing base feature engineering\ldots{} \ldots{}done. Input 69
variables and output 92 variables. Total rows: 8,247,499

Executing ZIP feature engineering\ldots{} \ldots{}Engineering done.
Input 92 variables and output 122 variables

\begin{verbatim}
 Running spatial indexing on 514,124 points
\end{verbatim}

ID column: bbl Max distance: 500 units=m Number of partions: 7 by 7, 49
total data partitions Parallel: TRUE with number of clusters set to 62

\begin{verbatim}
 ...done. Total indexing time: 5 mins
\end{verbatim}

Writing radii index to disk\ldots{} \ldots{}done Creating radii
features\ldots{} Running RADII feature creation Starting radii feature
creation at 2018-06-08 14:30:24 \ldots{} Building sales features\ldots{}
Creating building features\ldots{} Building moving average
features\ldots{} Building intensity features\ldots{} Joining new
features to original data\ldots{} Radii feature creation time: 3.47
hours \ldots{}done Writing radii features to disk\ldots{} \ldots{}done.
Writing took 3.99mins \ldots{}Engineering done. Input 92 variables and
output 194 variables

\begin{enumerate}
\def\labelenumi{\arabic{enumi})}
\tightlist
\item
  Create radii-index \& radii features
\item
  Create zip code features
\item
  Create 3 modeling data sets:
