...
The following two tables describe the distributions of both outcome variables:
...
knitr::kable(readr::read_rds("tables and figures/sold_summary_table5.rds"))
```
...
### Probability of Sale model diagnostics
