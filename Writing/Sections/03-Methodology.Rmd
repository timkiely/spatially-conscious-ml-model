...
Random Forest was proposed by Breiman @breiman2001random as an ensemble of prediction decision trees iteratively trained across randomly generated subsets of data. Algorithm \ref{alg:RandomForestAlo} outlines the procedure [@hastie01statisticallearning]. 
